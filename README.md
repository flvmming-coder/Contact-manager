...
## APK
- Основной файл: `artifacts/ContactManager-v0.11-debug.apk`
- Копия версии: `versions/Contact Manager v0.11/ContactManager-v0.11-debug.apk`

## Версии
- `versions/DEMO-v0` — нулевая DEMO-версия
- `versions/Contact Manager v0.11` — версия по HTML v0.11
